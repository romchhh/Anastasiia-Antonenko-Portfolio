...
export default function DownInFlamesPage() {
  ...
  const galleryImages = [
    // ROW 1
    // Column 1
    { src: '/Down In Flames/Anastasiia_Antonenko_Fragile Traces_06 2.png', width: 650, height: 940, top: 0, left: gap },
    // Column 2
    { src: '/Down In Flames/Anastasiia_Antonenko_Fragile Traces_06 3.png', width: 438, height: 615, top: 0, left: 700 },
    
    // ROW 2
    // Column 1
    { src: '/Down In Flames/Rectangle 78.png', width: 650, height: 458, top: 970, left: gap },
    // Column 2
    { src: '/Down In Flames/Anastasiia_Antonenko_Fragile Traces_06 10.png', width: 438, height: 615, top: 645, left: 700 },
    
    // ROW 3
    // Column 1 - two images side by side
    { src: '/Down In Flames/Anastasiia_Antonenko_Fragile Traces_06 8.png', width: 320, height: 444, top: 1458, left: gap },
    { src: '/Down In Flames/Anastasiia_Antonenko_Fragile Traces_06 9.png', width: 320, height: 444, top: 1458, left: 350 },
    // Column 2
    { src: '/Down In Flames/Anastasiia_Antonenko_Fragile Traces_06 11.png', width: 437, height: 612, top: 1290, left: 700 },
    
    // ROW 4
    // Column 1
    { src: '/Down In Flames/Anastasiia_Antonenko_Fragile Traces_06 14.png', width: 533, height: 776, top: 1932, left: gap },
    // Column 2
    { src: '/Down In Flames/Anastasiia_Antonenko_Fragile Traces_06 15.png', width: 553, height: 776, top: 1932, left: 585 }
  ];
              ...
              <aside className="text-[#1A1A1A]">
                <div className="space-y-8 pr-6 -ml-6">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-[16px] font-normal leading-[150%] tracking-[0.03em]">digital image, hand-burned photography</p>
                  </div>
                </div>
              </aside>
