...
export default function KyivInColorPage() {
  ...
  const galleryImages = [
    {
      src: "/Kyiv in Color/Rectangle 74.png",
      width: 638,
      height: 430,
      top: 0,
      left: gap,
        ...
        <main className="py-2 md:py-4 lg:py-8 px-5 md:px-2 lg:pl-12 lg:pr-8">
            ...
            <aside className="text-[#1A1A1A]">
              <div className="space-y-8 pr-6 -ml-6">
                ...
                <div>
                  ...
                  <p className="mt-2 text-[16px] font-normal leading-[150%] tracking-[0.03em]">
                    analog photography, hand-colored with marker
                  </p>
                </div>
              </div>
            </aside>
          ...
          <div
            ...
            style={{
              ...
              height: `${2677 * scale}px`,
            }}
          >
            <div
              className="relative"
              style={{ width: "1138px", height: "2677px" }}
            >
          ...
          <div className="md:hidden w-full max-w-full mt-6 flex flex-col gap-3 mx-auto">
            ...
            <div className="flex gap-3 w-full">
              <div className="flex flex-col w-55/10 gap-3">
                <img className="w-full h-auto" src={galleryImages[12].src} />
                <img className="w-full h-auto" src={galleryImages[7].src} />
              </div>
              <img src={galleryImages[5].src} className="mx-auto w-45/100" alt="" />
            </div>
