        ...
        <main className="py-2 md:py-4 lg:py-8 px-5 md:px-2 lg:pl-12 lg:pr-8">
          ...
          <div className="md:hidden w-full max-w-full mt-6 flex flex-col gap-3 mx-auto">
            ...
            <div className="flex gap-3 w-full ">
              <img className="w-[calc(50%-6px)] h-auto" src={galleryImages[2].src} />
              <img className="w-[calc(50%-6px)] h-auto" src={galleryImages[3].src} />
            </div>
            <div className="flex gap-3 w-full">
              <div className="flex flex-col gap-3 w-38/100">
              ...
              <div className="flex flex-col gap-3 w-60/100">
