    ...
    <div className="min-h-screen bg-[#F5F5F5] flex flex-col relative">
      ...
      <header className="bg-transparent relative">
        <div className="px-12 py-8">
          <h1 className="text-[45px] font-normal tracking-widest text-[#1A1A1A]">
          ...
          <div>
            <div className="relative">
              ...
              <div className="text-right mt-16 pr-12">
                <p className="text-[16px] text-[#515151]">stushaphotofilm@gmail.com</p>
              </div>
              ...
              <button
                onClick={nextSlide}
                className="absolute left-[calc(35%+1.5rem+58%-4rem)] top-1/2 -translate-y-1/2 w-10 h-10 rounded-full flex items-center justify-center transition-colors z-10"
                style={{ backgroundColor: '#A6A3A3B2' }}
                aria-label="Next"
              >
      ...
      {/* Sidebar Navigation - absolute, full page height and scrolls with content */}
        <aside className="absolute top-0 bottom-0 right-0 w-[17rem] bg-transparent border-l border-gray-300 flex flex-col">
          <nav className="p-8 pt-36">
            <ul className="space-y-6 text-[20px]">
              <li>
                <a href="#about" className="text-[#515151] tracking-wide hover:text-[#1A1A1A] transition-colors">
                  ABOUT
                </a>
              </li>
              <li>
                <a href="/portfolio" className="text-[#515151] tracking-wide hover:text-[#1A1A1A] transition-colors">
                  PORTFOLIO
                </a>
              </li>
              <li>
                <a href="#process" className="text-[#515151] tracking-wide hover:text-[#1A1A1A] transition-colors">
                  PROCESS
                </a>
              </li>
            </ul>
          ...
          {/* Horizontal line after menu: from vertical border to right edge */}
          ...
          <div className="flex-1 p-8 flex flex-col justify-end">
            ...
            <div className="flex gap-4 mb-6">
              <a href="#" className="text-[#1A1A1A] hover:text-[#515151] transition-colors" aria-label="Facebook">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="#" className="text-[#1A1A1A] hover:text-[#515151] transition-colors" aria-label="Instagram">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" className="text-[#1A1A1A] hover:text-[#515151] transition-colors" aria-label="WhatsApp">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
